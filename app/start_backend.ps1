# Start TTS Backend Service Silently
# Khởi động Dịch vụ TTS Backend Im lặng
...
Write-Host "Starting TTS Backend in background..." -ForegroundColor Cyan
Write-Host "Đang khởi động TTS Backend ở chế độ nền..." -ForegroundColor Cyan
...
try {
    ...
    Write-Host ""
    Write-Host "To stop: .\stop_backend.ps1" -ForegroundColor Yellow
    Write-Host "Để dừng: .\stop_backend.ps1" -ForegroundColor Yellow
