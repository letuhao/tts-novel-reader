...
# This backend is in tts/vieneu-tts-backend/tts_backend/config.py
# Go up 4 levels to project root: config -> tts_backend -> vieneu-tts-backend -> tts -> novel-reader
# Backend này ở trong tts/vieneu-tts-backend/tts_backend/config.py
# Đi lên 4 cấp để đến root dự án: config -> tts_backend -> vieneu-tts-backend -> tts -> novel-reader
