#!/usr/bin/env python
"""
Stop DangVanSam VietTTS Backend Service
Dừng Dịch vụ DangVanSam VietTTS Backend
"""
import subprocess
import sys
import os
...
print("Stopping DangVanSam VietTTS Backend...")
print("Đang dừng DangVanSam VietTTS Backend...")
...
if processes_to_stop:
    ...
    if stopped:
        ...
        print("")
        print("✅ DangVanSam VietTTS Backend stopped")
        print("✅ DangVanSam VietTTS Backend đã được dừng")
    else:
    ...
    try:
        ...
        print("   ℹ️  No DangVanSam VietTTS Backend process found on port 11111")
        print("   ℹ️  Không tìm thấy process DangVanSam VietTTS Backend trên port 11111")
