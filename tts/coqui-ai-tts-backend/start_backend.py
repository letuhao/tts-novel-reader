#!/usr/bin/env python
"""
Start Coqui TTS Backend Service Silently
Khởi động Dịch vụ Coqui TTS Backend Im lặng
"""
import subprocess
import sys
import os
...
if check_backend_running():
    print("⚠️  Coqui TTS Backend is already running on port 11111!")
    print("⚠️  Coqui TTS Backend đang chạy trên port 11111 rồi!")
...
print("Starting Coqui TTS Backend in background...")
print("Đang khởi động Coqui TTS Backend ở chế độ nền...")
...
if check_backend_running():
    ...
    print("✅ Coqui TTS Backend đã được khởi động thành công!")
    print("")
